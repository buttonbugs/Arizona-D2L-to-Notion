...
Arizona D2L to Notion is a chrome extension that can automatically sync your [Arizona D2L](https://d2l.arizona.edu/d2l/home), [zyBooks](https://www.zybooks.com/), [Gradescope](https://www.gradescope.com/), [Pearson Mastering](https://mycourses.pearson.com/course-home) and [WebAssign](https://www.webassign.net/v4cgi/student.pl) course data (assignments, quizzes, exams, and submission status) into your [Notion database](https://www.notion.com/help/intro-to-databases).
...
- The tasks without due dates will be displayed in the bottom of the database (if the database is sorted according to due dates), so don't forget to check the bottom of the database
